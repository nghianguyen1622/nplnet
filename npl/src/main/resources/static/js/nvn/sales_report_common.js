...
function validateDateRange(reportType, callbackFunction) {
	...
	if (days >= 7 && days <= 30) {
		...
		startDateField.setCustomValidity("Lọc trong khoảng 7-30 ngày");
...
function getChartTitle(period) {
	if (period == "last_7_days") return "Bán hàng trong 7 ngày qua";
	if (period == "last_28_days") return "Bán hàng trong 28 ngày qua";
	if (period == "last_6_months") return "Bán hàng trong 6 tháng trước";
	if (period == "last_year") return "Bán hàng trong năm nay";
	if (period == "custom") return "Lọc theo ngày tháng";
