...
public class CompanyDaoExtend {
	...
	public ResultProcDto save(CompanyDto dto) {
		...
		query.setParameter("p_com_cd",                            dto.getComId());
		...
		query.setParameter("p_bank_cd",                           "");
		query.setParameter("p_bank_name",                         "");
		...
		query.setParameter("p_file_name_org",                     dto.getFileNameOrg());
