...
public class NoticeDaoExtend {
	...
	public ResultProcDto callNoticeAdd(NoticeDto noticeDto){
		...
		final StoredProcedureQuery query = entityManager.createStoredProcedureQuery("\"PRC_NOTICE\"");
	...
	public ResultProcDto callNoticeDel(String id) throws Exception{
		...
		final StoredProcedureQuery query = entityManager.createStoredProcedureQuery("\"PRC_NOTICE_DEL\"");
